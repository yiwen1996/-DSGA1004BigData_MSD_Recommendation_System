...
'''
Usage:
$ spark-submit --driver-memory=8g --executor-memory=8g --conf "spark.blacklist.enabled=false" param_train_1st.py hdfs:/user/te2049/train_index_downsample.parquet hdfs:/user/bm106/pub/MSD/cf_validation.parquet hdfs:/user/te2049/indexer_downsample.parquet
'''
